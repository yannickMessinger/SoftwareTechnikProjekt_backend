...
public class PositionController{
    ...
    public PositionMessage create(PositionMessage positionMessage) {
        ...
        positionService.createPosition( positionMessage.getId(),positionMessage.content.x(),positionMessage.content.y(),positionMessage.content.rotation());
    ...
    public PositionMessage update(@Payload PositionMessage positionMessage) {
        ...
        positionService.updatePosition(positionMessage.getId(),positionMessage.content.x(), positionMessage.content.y(), positionMessage.content.rotation()  );
        //headerAccessor.getSessionAttributes().put("username", editorMessage.getAuthor());
        return positionMessage;
    }
